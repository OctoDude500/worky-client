        ...
        <main >
            ...
            <div class="how-cards">
                <div class="card-container form-container">
                    <form class="application_container" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" novalidate>
                        <div class="form-div">
                        ...
                        <div class="form-div">
                         ...
                         <div class="form-div">
                            ...
                            <select name="workplace" id="workplace">
                                <option value="default" selected>Select workplace</option>
                        ...
                        <div class="form-div">
                            <label for="attempts">Have you been reffered or applied before?</label>
                            <select name="attempts" id="attemps">
                                <option value="default" selected>Select attempts history</option>
